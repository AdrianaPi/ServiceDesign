...
¿Cómo podríamos tranquilizar a las personas que no reciben el dinero del ATM pero sí obtuvieron un comprobante (ticket o mensaje) de que el retiro ocurrió con éxito?
...
Por medio del ejercicio de Clustering, agrupamos las ideas de crazy´s 8 por afinidad y complementación; y con Telescoping, las big ideas fueron sometidas a votación por nosotras y por cinco usuarios para obtener las ideas más afines a la solución de la problemática. Finalmente realizamos la matriz de relevancia para priorizar e identificar las ideas más alineadas a la solución, con más relevancia y diferenciación. Las tres destacadas fueron: 

![clustering](https://i.ibb.co/D85vpFm/Captura-de-pantalla-2019-06-03-a-la-s-22-44-08.png)
...
La técnica que elegimos fue realizar un simulacro de baja fidelidad. Consistió en hacer bocetos de la información que aparecerá en la pantalla de un cajero automático para hacer un reporte de problema; elaboración y redacción de un ticket de reporte, un cartel con información para atención vía telefónica, opciones de seguimiento con pantallas de la aplicación y del sitio web de Citibanamex. 
...
Para tener un control y una mejor observación del testeo se elaboró un user test planning canvas para seccionar las tareas, y métricas más importantes a considerar.
El prototipo se testeó con cinco personas y la información se vació en un user test analysis canvas. Se utilizaron las técnicas de think aloud y walkthrough.
...
Después de iterar y  corregir los errores de mensaje y flujo de navegación,  se plasmaron las ideas de bocetos a un prototipo de alta fidelidad por medio de Adobe XD y Marvel.

Las propuestas de valor corresponde a cinco touchpoint de más contacto al momento de suscitarse el problema y en los cuales brindamos soluciones para tranquilizar ante una falta de personal físico. 
...
Puedes ver el prototipo de la aplicación aquí. (poner liga)
